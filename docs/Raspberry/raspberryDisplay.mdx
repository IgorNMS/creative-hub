...
E apenas um tutorial de um codigo simples em python para mostrar o status do RaspberryPi.

Status como, consumo de memoria RAM, consumo do HD, uso do processador e etc..
